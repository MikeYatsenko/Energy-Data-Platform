...
SQL1 = """CREATE TABLE nuclear_data(
    index int,
    date_pulled text,
    date text,
...
SQL2 = """
DELETE FROM nuclear_data
WHERE date_pulled = %s;
"""


SQL3 = """INSERT INTO nuclear_data(index, date_pulled, date, california, central, mid_atlantic, new_england, 
...
def lambda_handler(event, context):
    ...
    csv_file = s3.Object(bucket_name, f'nuclear/{datetime.date.today()}_energy_data_nuclear.csv').get()
